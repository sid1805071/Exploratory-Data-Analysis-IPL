# -*- coding: utf-8 -*-
"""Task 1_EDA - Sports.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1QkPVbCrUsCm7ff7iifn34WPM5US_x3ID

# Task 1: The Sparks Foundation April'21 (GRIP@TSF)

### Exploratory Data Analysis - Sports

> Indented block

Description:-> Performing ‘Exploratory Data Analysis on dataset ‘Indian Premier League’(Advance level)
...
matches.head() #showing first 5 records

matches.tail() #showing last 5 records

"""# Data information:"""

matches.info()

matches.shape #to know the rows and columns

matches.describe() #description like mean,median,percentiles...
...
"""# Now we are going to merge the two given datasets in order to draw some meaningful inferences."""
...
matches.id.is_unique ## since the id is unique we can set it as our index(primary key)
...
matches[matches.city.isnull()][['city','venue']] ##So, missing values can be filled with Dubai

matches.city = matches.city.fillna('Dubai') ##umpire1 and umpire2 columns have one missing value each.

matches[(matches.umpire1.isnull()) | (matches.umpire2.isnull())] #3Umpire3 column has close to 92% missing values. hence dropping that column
...
"""#            ____________________ANALYSIS____
